...
PayloadMeasurements::PayloadMeasurements(const Payload payload):batteryCurrent(-qInf()), motorCurrent(-qInf()), servo1(-qInf()), servo2(-qInf()), servo3(-qInf()), servo4(-qInf()), batteryVoltage(-qInf()), panelVoltage(-qInf()), panelCurrent(-qInf()){

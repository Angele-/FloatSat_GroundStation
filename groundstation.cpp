...
void GroundStation::doPlotDataRate(){
    ...
    plotDataRate->yAxis->setRange(0, plotDataRate->yAxis->range().upper * 0.97);
...
void GroundStation::readFromLink(){
    ...
    case PayloadMeasurementsType:{
        ...
        static double key = 0;
        key += PLOT_PUBLISH_INTERVAL;
        plotCurrent->yAxis->setRange(0, plotCurrent->yAxis->range().upper * 0.97);
        ...
        plotVoltage->yAxis->setRange(0, plotVoltage->yAxis->range().upper * 0.97);
